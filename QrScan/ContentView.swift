...
struct ContentView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            .accessibilityIdentifier("home.page.pager")
            .onAppear(perform: loadClipboardIfNeeded)
    ...
    private var generatorPage: some View {
        ScrollView {
            VStack(spacing: 16) {
                TextEditor(text: $scannedText)
                    ...
                    .accessibilityIdentifier("home.payload.editor")
        ...
        .accessibilityIdentifier("home.generator.page")
    }
    ...
    private var historyPage: some View {
        ScrollView {
            ScanHistorySection(
                ...
                copySuccessMessage: t("home.copy.success"),
        ...
        .accessibilityIdentifier("home.history.page")
    }
    ...
    private func saveQRCode() {
        dismissKeyboard()
        guard let qrImage = generatedQRCode else { return }
